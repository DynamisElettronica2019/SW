...
void data_indicatorsInit(void)
{
	  ...
	  Indicators[ANTISTALL] 				= (Indicator_Value) {ANTISTALL, INT, "ANTIST", DEF_VALUE, DEF_VALUE, DEF_VALUE,"?"};
		Indicators[BPS_F] 						= (Indicator_Value) {BPS_F, INT, "BPS_F", DEF_VALUE, DEF_VALUE, DEF_VALUE,"?"};
		Indicators[BPS_R]							= (Indicator_Value) {BPS_R, INT, "BPS_R", DEF_VALUE, DEF_VALUE, DEF_VALUE,"?"};
		Indicators[BRAKE_BIAS]			 	= (Indicator_Value) {BRAKE_BIAS, INT, "BRAKE_BIAS", DEF_VALUE, DEF_VALUE, DEF_VALUE,"?"};
