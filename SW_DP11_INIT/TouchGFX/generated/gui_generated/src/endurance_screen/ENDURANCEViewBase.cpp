...
ENDURANCEViewBase::ENDURANCEViewBase()
{
    ...
    Unicode::snprintf(textIndGearValueBuffer, TEXTINDGEARVALUE_SIZE, "%s", TypedText(T_SINGLEUSEID258).getText());
    textIndGearValue.setWildcard(textIndGearValueBuffer);
    textIndGearValue.resizeToCurrentText();
    textIndGearValue.setTypedText(TypedText(T_SINGLEUSEID257));
