...
AUTOCROSSViewBase::AUTOCROSSViewBase()
{
    ...
    textIndTitle1.setWildcard(TypedText(T_SINGLEUSEID73).getText());
    ...
    textIndTitle2.setWildcard(TypedText(T_SINGLEUSEID75).getText());
    ...
    textIndTitle3.setWildcard(TypedText(T_SINGLEUSEID77).getText());
    ...
    textIndTitle4.setWildcard(TypedText(T_SINGLEUSEID79).getText());
    ...
    textIndTitle5.setWildcard(TypedText(T_SINGLEUSEID81).getText());
    ...
    textIndTitle6.setWildcard(TypedText(T_SINGLEUSEID83).getText());
    ...
    textIndValue1.setWildcard(TypedText(T_SINGLEUSEID85).getText());
    ...
    textIndValue2.setWildcard(TypedText(T_SINGLEUSEID87).getText());
    ...
    textIndValue3.setWildcard(TypedText(T_SINGLEUSEID89).getText());
    ...
    textIndValue4.setWildcard(TypedText(T_SINGLEUSEID91).getText());
    ...
    textIndValue5.setWildcard(TypedText(T_SINGLEUSEID93).getText());
    ...
    textIndValue6.setWildcard(TypedText(T_SINGLEUSEID95).getText());
    ...
    textIndGearValue.setTypedText(TypedText(T_SINGLEUSEID96));
    ...
    textIndTcValue.setWildcard(TypedText(T_SINGLEUSEID100).getText());
    ...
    textIndMapValue.setWildcard(TypedText(T_SINGLEUSEID102).getText());
    ...
    textIndAcquisitionValue.setWildcard(TypedText(T_SINGLEUSEID105).getText());
    ...
    textIndValue6_1.setWildcard(TypedText(T_SINGLEUSEID144).getText());
    textIndValue6_1.setTypedText(TypedText(T_SINGLEUSEID143));
