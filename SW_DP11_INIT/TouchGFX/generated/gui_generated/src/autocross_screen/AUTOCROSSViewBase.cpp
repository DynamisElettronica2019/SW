...
AUTOCROSSViewBase::AUTOCROSSViewBase()
{
    ...
    Unicode::snprintf(textIndGearValueBuffer, TEXTINDGEARVALUE_SIZE, "%s", TypedText(T_SINGLEUSEID260).getText());
    textIndGearValue.setWildcard(textIndGearValueBuffer);
    textIndGearValue.resizeToCurrentText();
    textIndGearValue.setTypedText(TypedText(T_SINGLEUSEID259));
